...
contract ERC20NonTransferable is ERC20Upgradeable, AccessControl {
    ...
    bytes32 constant operationNameOR = keccak256(abi.encodePacked(("AND")));
    ...
    {
        bool isAdmin = hasRole(ADMIN, msg.sender);
